...
### Prerequisites
  ...
  - Scipy version 1.1.0 otherwise error is thrown for imresize. 
  - torchvision version 0.2.0. This is the only version compatible with torch version 0.3.1 right now.
